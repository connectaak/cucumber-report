export const getTrendChartData=(data)=>{
  ...
  data?.forEach((feature) => {
    ...
    feature?.elements?.forEach((scenario) => {
      ...
      const passedDuration = scenarioStatus !== 'failed' ? scenarioPassedDuration / 1000000 : 0;
      const failedDuration = scenarioStatus === 'failed' ? scenarioFailedDuration / 1000000 : 0;
      scenarioStatus = passedDuration > 0 ? 'passed' : 'failed'; // set status based on passed duration
      scenarios.push({
        name: scenarioName,
